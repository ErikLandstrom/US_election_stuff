...
# Plots a scatterplot with character strings instead of dots,
# with geom smoot being optional.
...
# column1 = column1
# column2 = column2
# text = character, strings to plot instead of dots
...
plot_scatterplot_text <- function(data, column1, column2, text, y_label, x_label, 
